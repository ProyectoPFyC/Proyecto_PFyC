...
val finca0 = Vector((5,2,4), (4,1,2), (2,3,3), (5,4,2))
val finca1 = Vector((10,3,4), (5,3,3), (2,2,1), (8,1,1), (6,4,2))
val finca2 = Vector((9,4,4), (1,5,4), (1,4,1), (10,3,2), (1,6,1), (8,7,2), (4,6,3))
val finca3 = Vector((12,3,4), (1,7,4), (4,1,1), (11,6,1), (7,3,4), (13,3,2), (13,5,1), (11,2,1))
val finca4 = Vector((8,5,4), (12,9,4), (2,2,3), (6,3,1), (9,5,3), (14,2,4), (19,7,3), (19,1,2), (19,8,4), (2,1,3))
val finca5 = Vector((4,7,4), (4,11,1), (20,7,2), (16,10,4), (2,5,2), (6,9,2), (23,2,4), (7,11,1), (22,8,1), (22,5,4), (21,10,1), (14,12,2))
val finca6 = Vector((25,13,4), (2,7,4), (8,7,1), (7,5,4), (10,4,4), (19,10,3), (5,4,2), (10,7,3), (10,9,2), (25,13,2), (13,10,3), (8,2,3), (14,12,1))

val riego0 = Vector(1, 0, 3, 2)
val riego1 = Vector(0, 1, 4, 2, 3)
val riego2 = Vector(6, 4, 2, 1, 3, 5, 0)
val riego3 = Vector(4, 6, 2, 0, 5, 1, 3, 7)
val riego4 = Vector(4, 8, 1, 3, 2, 7, 0, 5, 9, 6)
val riego  = Vector(1, 10, 6, 8, 9, 7, 3, 0, 5, 4, 11, 2)
val riego6 = Vector(7, 10, 1, 9, 6, 11, 2, 0, 12, 8, 5, 3, 4)

val distancia0 = Vector(Vector(0, 8, 7, 8), Vector(5, 0, 10, 8), Vector(1, 10, 0, 10), Vector(4, 3, 8, 0))
val distancia1 = Vector(Vector(0,2,2,4,4), Vector(2,0,4,2,6), Vector(2,4,0,2,2), Vector(4,2,2,0,4), Vector(4,6,2,4,0))
val distancia2 = Vector(Vector(0, 5, 13, 15, 5, 14, 16), Vector(20, 0, 12, 6, 7, 10, 12), Vector(6, 2, 0, 13, 4, 3, 20), Vector(1, 14, 18, 0, 1, 15, 10), Vector(16, 19, 16, 11, 0, 1, 9), Vector(3, 13, 12, 16, 8, 0, 21), Vector(15, 18, 5, 20, 12, 5, 0))
val distancia3 = Vector(Vector(0, 14, 15, 22, 11, 17, 3, 9), Vector(23, 0, 18, 1, 3, 20, 11, 14), Vector(15, 21, 0, 5, 15, 23, 11, 17), Vector(4, 6, 20, 0, 3, 8, 14, 20), Vector(9, 21, 5, 12, 0, 5, 16, 20), Vector(23, 20, 20, 24, 2, 0, 2, 15), Vector(3, 1, 6, 6, 21, 4, 0, 4), Vector(19, 23, 8, 7, 21, 14, 22, 0))
val distancia4 = Vector(Vector(0, 5, 4, 21, 3, 18, 15, 11, 2, 9), Vector(23, 0, 30, 28, 16, 25, 1, 7, 13, 9), Vector(30, 24, 0, 1, 30, 9, 7, 9, 10, 4), Vector(4, 18, 25, 0, 25, 5, 11, 18, 29, 7), Vector(9, 10, 17, 11, 0, 8, 20, 4, 23, 21), Vector(12, 7, 8, 22, 28, 0, 11, 24, 5, 12), Vector(26, 17, 25, 13, 28, 29, 0, 25, 9, 11), Vector(15, 17, 29, 3, 28, 25, 18, 0, 11, 28), Vector(10, 3, 19, 18, 10, 30, 26, 12, 0, 12), Vector(19, 25, 16, 4, 6, 1, 20, 15, 29, 0))
val distancia5 = Vector(Vector(0, 30, 22, 5, 23, 29, 1, 25, 31, 16, 2, 11), Vector(2, 0, 25, 25, 36, 30, 31, 27, 33, 32, 10, 3), Vector(36, 15, 0, 25, 30, 2, 17, 26, 14, 34, 7, 12), Vector(30, 34, 20, 0, 33, 7, 20, 24, 28, 27, 16, 7), Vector(15, 26, 10, 8, 0, 21, 24, 14, 22, 15, 10, 27), Vector(29, 16, 17, 25, 28, 0, 12, 33, 28, 33, 18, 6), Vector(36, 18, 24, 11, 34, 32, 0, 28, 17, 14, 12, 30), Vector(12, 7, 28, 17, 21, 28, 28, 0, 29, 14, 16, 26), Vector(15, 10, 12, 32, 16, 6, 14, 1, 0, 19, 12, 24), Vector(7, 26, 19, 27, 12, 19, 29, 7, 7, 0, 3, 18), Vector(28, 30, 21, 31, 27, 11, 18, 3, 6, 28, 0, 7), Vector(22, 24, 28, 7, 9, 14, 33, 32, 27, 8, 15, 0))
